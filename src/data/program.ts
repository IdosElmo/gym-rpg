...
export const EXTRA_EXERCISES: readonly Exercise[] = [
  ...
  {
    // A ZONE-2 RIDE: two hours on the bike at a conversational effort, logged
    // as twelve 10-minute stages. The load is the POWER the bike reads out, and
    // the ladder is FLAT (`loadStep: 0`) — the whole point of zone 2 is holding
    // one effort, so a stage's volume is watts × minutes and the personal
    // record is more watts at the same heart rate, not a steeper stage.
    id: 'x22',
    he: 'אופניים — זון 2 (שעתיים)',
    en: 'Stationary Bike — Zone 2 (2 h)',
    equip: ['Machine'],
    muscle: 'קרדיו · רגליים',
    sets: 12,
    reps: '10 דק׳',
    ...
    unit: 'דקות',
    steps: [
      'כוונו את גובה הכיסא כך שהברך נשארת מעט כפופה בתחתית הדיווש.',
      'רכבו בקצב 80–90 סיבובים לדקה בהתנגדות שמחזיקה את הדופק ב‑60–70% מהמקסימום — אפשר לדבר במשפטים שלמים.',
      'סמנו ✓ בסוף כל 10 דקות: הטיימר של השלב הבא מתחיל לבד, וההספק נשאר אותו הספק.',
      'שתו כל 20 דקות; הגו רפוי, הכתפיים רחוקות מהאוזניים והידיים נחות על הכידון בלי להישען עליו.',
    ],
    cue: 'אם אתם מתנשפים — האטו; זון 2 הוא הקצב שאפשר להחזיק שעתיים בלי להילחם עליו.',
    mistake: 'טעות נפוצה: להתחיל חזק מדי ולגלוש לזון 3 אחרי חצי שעה — שעתיים איטיות שוות יותר משעה מהירה.',
    bodyPart: 'legs',
    split: { legs: 0.85, core: 0.15 },
    cardio: { loadLabel: 'הספק', loadUnit: 'W', loadStart: 120, loadStep: 0 },
  },
  {
    // VO2-MAX INTERVALS: the 4×4 — four hard efforts of four minutes, three
    // easy minutes between them. A stage is one HARD interval; the recovery is
    // the pause before the next ✓, which is what starts the next stage's
    // timer. Same flat ladder: every interval aims at the same power.
    id: 'x23',
    he: 'אופניים — אינטרוולים VO2 max',
    en: 'Stationary Bike — VO2 Max Intervals (4×4)',
    equip: ['Machine'],
    muscle: 'קרדיו · רגליים',
    sets: 4,
    reps: '4 דק׳',
    ...
    unit: 'דקות',
    steps: [
      'חממו 10 דקות בקלות לפני השלב הראשון; לחצו ▶ כשמתחילים לדחוף.',
      'דוושו 4 דקות בהתנגדות שמביאה את הדופק ל‑90–95% מהמקסימום עד סוף הדקה השנייה — קשה, לא ספרינט.',
      'בסיום ה‑4 דקות רדו להתנגדות קלה ל‑3 דקות התאוששות, וסמנו ✓ רק כשמתחילים את האינטרוול הבא.',
      'שמרו על אותו הספק בכל ארבעת השלבים; אם הרביעי נופל בהרבה מהראשון — ההספק היה גבוה מדי.',
    ],
    cue: 'הדקה האחרונה של כל אינטרוול היא זו שבונה את ה‑VO2 max — אל תוותרו עליה.',
    mistake: 'טעות נפוצה: ספרינט בדקה הראשונה שנגמר בדקה השנייה — ההספק צריך להיות שווה לאורך כל 4 הדקות.',
    bodyPart: 'legs',
    split: { legs: 0.85, core: 0.15 },
    cardio: { loadLabel: 'הספק', loadUnit: 'W', loadStart: 220, loadStep: 0 },
  },
  {
    id: 'x24',
    he: 'קלין אנד פרס עם משקולות',
    en: 'Dumbbell Clean and Press',
    equip: ['Dumbbells'],
    muscle: 'כתפיים · רגליים · גב',
    sets: 4,
    reps: '10',
    rest: 90,
    unit: 'חזרות',
    steps: [
      'עמדו ברוחב כתפיים, משקולת בכל יד לצידי השוקיים, אגן לאחור וגב שטוח.',
      'דחפו מהרגליים ופשטו את האגן בחדות; המשקולות עולות צמוד לגוף, המרפקים מובילים למעלה.',
      'קלטו את המשקולות על הכתפיים ("ראק") עם המרפקים קדימה וברכיים רכות.',
      'לחצו את המשקולות ישר מעל הראש עד פשיטה מלאה, והורידו בשליטה — קודם לכתפיים, אחר כך לשוקיים.',
    ],
    cue: 'הכוח לקלין מגיע מהרגליים ומהאגן, לא מהזרועות — הידיים רק מלוות את המשקולות למעלה.',
    mistake: 'טעות נפוצה: לכופף את המרפקים מוקדם ולהפוך את הקלין לכפיפת מרפקים כבדה, או לקשת את הגב התחתון בלחיצה.',
    bodyPart: 'shoulders',
    split: { shoulders: 0.4, legs: 0.35, back: 0.25 },
  },
  {
    id: 'x25',
    he: 'דד באג (Dead Bug)',
    en: 'Dead Bug',
    equip: ['Bodyweight'],
    muscle: 'ליבה עמוקה · ייצוב אגן',
    sets: 4,
    reps: '20 (10 לצד)',
    rest: 45,
    unit: 'חזרות',
    steps: [
      'שכבו על הגב, ידיים ישרות אל התקרה, ירכיים אנכיות וברכיים ב‑90 מעלות.',
      'הצמידו את הגב התחתון למזרן ונשפו — זו הנקודה שאסור לאבד.',
      'הורידו לאט יד אחת מאחורי הראש ואת הרגל הנגדית קדימה, עד שכמעט נוגעות ברצפה.',
      'חזרו לאמצע ועברו לצד השני; היד והרגל האחרות נשארות בדיוק במקום.',
    ],
    cue: 'הזרוע והרגל נעות — הגב התחתון והאגן לא זזים מילימטר.',
    mistake: 'טעות נפוצה: הגב התחתון מתקשת ומתרומם מהמזרן כשהרגל יורדת — הורידו פחות, לא מהר יותר.',
    bodyPart: 'core',
  },
  {
    id: 'x26',
    ...
    en: 'Side Plank',
    equip: ['Bodyweight'],
    muscle: 'אלכסונים · ייצוב צידי',
    sets: 4,
    reps: '40 שנ׳ לצד',
    rest: 45,
    unit: 'שניות',
    steps: [
      'שכבו על הצד, המרפק בדיוק מתחת לכתף והאמה על המזרן, כפות הרגליים זו על זו.',
      'הרימו את האגן עד שהגוף קו ישר אחד מהראש לעקבים.',
      'היד העליונה על הירך או ישרה אל התקרה; המבט קדימה, לא למטה.',
      'החזיקו את הזמן ונשמו — ואז החליפו צד ללא מנוחה.',
    ],
    cue: 'דחפו את הרצפה עם המרפק והרימו את האגן — אל תתנו לו לשקוע.',
    mistake: 'טעות נפוצה: האגן שוקע אחורה או הכתף נדחפת לאוזן — הגוף חייב להישאר במישור אחד.',
    bodyPart: 'core',
  },
  {
    id: 'x27',
    he: 'בירד דוג (Bird Dog)',
    en: 'Bird Dog',
    equip: ['Bodyweight'],
    muscle: 'ליבה · זוקפי גב · ישבן',
    sets: 4,
    reps: '20 (10 לצד)',
    rest: 45,
    unit: 'חזרות',
    steps: [
      'על שש: ידיים מתחת לכתפיים, ברכיים מתחת לאגן, גב שטוח ומבט לרצפה.',
      'הרחיקו יד אחת קדימה ואת הרגל הנגדית אחורה בו‑זמנית, עד שהן בקו אחד עם הגו.',
      'עצרו שנייה, כווצו ישבן, וחזרו לאט בלי לנוח על הרצפה.',
      'החליפו צד; האגן והכתפיים נשארים מקבילים לרצפה לאורך כל התנועה.',
    ],
    cue: 'דמיינו כוס מים על הגב התחתון — היא לא נשפכת.',
    mistake: 'טעות נפוצה: הרמת הרגל גבוה מהאגן וקישות הגב, או סיבוב האגן לצד.',
    bodyPart: 'core',
    split: { core: 0.6, back: 0.4 },
  },
  {
    id: 'x28',
    he: 'סקוואט בולגרי (רגל אחורית על ספסל)',
    ...
    unit: 'חזרות/רגל',
    steps: [
      'עמדו עם הגב לספסל, והניחו את כף הרגל האחורית על הכרית; הרגל הקדמית צעד גדול קדימה.',
      'משקולות לצידי הגוף, גו זקוף, ליבה מכווצת.',
      'רדו אנכית עד שהירך הקדמית מקבילה לרצפה והברך האחורית כמעט נוגעת בה.',
      'דחפו דרך כל כף הרגל הקדמית חזרה למעלה; סיימו את כל החזרות ואז החליפו רגל.',
    ],
    cue: 'המשקל על הרגל הקדמית — הרגל האחורית רק שומרת על שיווי משקל.',
    mistake: 'טעות נפוצה: צעד קצר מדי שמכניס את הברך הקדמית הרחק מעבר לבהונות, או רכינה קדימה.',
    bodyPart: 'legs',
  },
  {
    id: 'x29',
    he: 'דדליפט רומני על רגל אחת',
    en: 'Single-Leg Romanian Deadlift',
    equip: ['Dumbbells', 'Bodyweight'],
    muscle: 'ירך אחורית · ישבן · ייצוב',
    sets: 4,
    reps: '8 לרגל',
    rest: 90,
    unit: 'חזרות/רגל',
    steps: [
      'עמדו על רגל אחת עם ברך רכה, משקולת בכל יד (או אחת ביד הנגדית לרגל העומדת).',
      'הטו את הגו קדימה מהאגן והרימו את הרגל החופשית אחורה, כך שהגו והרגל קו ישר אחד.',
      'רדו עד שהמשקולות בגובה אמצע השוק והגב עדיין שטוח.',
      'כווצו ישבן ופשטו את האגן חזרה לעמידה; סיימו את החזרות ואז החליפו רגל.',
    ],
    cue: 'האגן מקביל לרצפה — הבוהן של הרגל המורמת מצביעה למטה, לא לצד.',
    mistake: 'טעות נפוצה: פתיחת האגן לצד או עיגול הגב כדי להגיע נמוך יותר.',
    bodyPart: 'legs',
    split: { legs: 0.7, back: 0.3 },
  },
  {
    ...
    en: 'Push-Up',
    equip: ['Bodyweight'],
    muscle: 'חזה · טרייספס · ליבה',
    sets: 3,
    reps: '10–15',
    rest: 60,
    unit: 'חזרות',
    steps: [
      'ידיים על הרצפה מעט רחב מהכתפיים, בקו הכתפיים; הגוף קו ישר אחד מהראש לעקבים.',
      'כווצו ישבן וליבה, ורדו בשליטה כשהמרפקים נפתחים לאחור בזווית של כ‑45 מעלות.',
      'רדו עד שהחזה כמעט נוגע ברצפה — אגוף אחד מעליה.',
      'דחפו את הרצפה חזרה למעלה עד פשיטה מלאה, בלי לאבד את הקו הישר.',
    ],
    cue: 'דמיינו שאתם דוחפים את הרצפה מכם והלאה — הגוף עולה כיחידה אחת, האגן לא נשאר מאחור.',
    mistake: 'טעות נפוצה: אגן שוקע או מתרומם, או חצי טווח — הראש מתקרב לרצפה אבל החזה לא.',
    bodyPart: 'chest',
    split: { chest: 0.6, arms: 0.25, core: 0.15 },
  },
  {
    id: 'x31',
    ...
    en: 'Diamond Push-Up',
    equip: ['Bodyweight'],
    muscle: 'טרייספס · חזה פנימי',
    sets: 3,
    reps: '8–12',
    rest: 60,
    unit: 'חזרות',
    steps: [
      'הצמידו את הידיים זו לזו מתחת לאמצע החזה, כך שהאגודלים והאצבעות המורות יוצרים יהלום.',
      'גוף בקו ישר, מרפקים צמודים לצלעות ומצביעים אחורה — לא לצדדים.',
      'רדו בשליטה עד שהחזה נוגע בגב הידיים.',
      'לחצו חזרה למעלה תוך כיווץ הטרייספס; המרפקים נשארים קרובים לגוף.',
    ],
    cue: 'המרפקים מחליקים לאחור לאורך הצלעות — זה מה שמעביר את העבודה לטרייספס.',
    mistake: 'טעות נפוצה: מרפקים שנפתחים לצדדים או כתפיים שנמשכות לאוזניים בתחתית.',
    bodyPart: 'arms',
    split: { arms: 0.5, chest: 0.4, core: 0.1 },
  },
  {
    id: 'x32',
    he: 'שכיבות סמיכה ברוחב',
    en: 'Wide Push-Up',
    equip: ['Bodyweight'],
    muscle: 'חזה · כתפיים קדמיות',
    sets: 3,
    reps: '10–15',
    rest: 60,
    unit: 'חזרות',
    steps: [
      'הניחו את הידיים רחב מהכתפיים בכפליים, בקו החזה העליון, אצבעות מצביעות מעט החוצה.',
      'גוף בקו ישר, שכמות מכווצות מעט לאחור.',
      'רדו בשליטה כשהמרפקים נפתחים לצדדים, עד שהחזה בגובה אגרוף מהרצפה — הטווח קצר יותר מרגיל.',
      'לחצו חזרה למעלה תוך כיווץ החזה; אל תנעלו את המרפקים בחבטה.',
    ],
    cue: 'מתחו את הרצפה לצדדים בכפות הידיים — כך החזה עובד והכתפיים נשארות יציבות.',
    mistake: 'טעות נפוצה: לרדת עמוק מדי עם ידיים רחבות ולהעמיס על הכתף הקדמית, או אגן שנופל.',
    bodyPart: 'chest',
    split: { chest: 0.7, shoulders: 0.2, arms: 0.1 },
  },
  {
    id: 'x33',
    he: 'הולו בודי (Hollow Body Hold)',
    en: 'Hollow Body Hold',
    equip: ['Bodyweight'],
    muscle: 'ליבה עמוקה · בטן',
    sets: 3,
    reps: '30–45 שנ׳',
    rest: 45,
    unit: 'שניות',
    steps: [
      'שכבו על הגב והצמידו את הגב התחתון למזרן — זו הנקודה שכל התרגיל שומר עליה.',
      'הרימו את השכמות והרגליים מהמזרן, רגליים ישרות ובהונות מכוונות; הידיים ישרות מעל הראש.',
      'הגוף בצורת קשת רדודה, סנטר מעט פנימה, מבט אל הברכיים.',
      'החזיקו את הזמן ונשמו; ככל שהרגליים והידיים נמוכות יותר — קשה יותר.',
    ],
    cue: 'לחצו את הגב התחתון אל המזרן כאילו מוחקים את החלל מתחתיו.',
    mistake: 'טעות נפוצה: הגב התחתון מתקשת ומתרומם מהמזרן — הרימו את הרגליים גבוה יותר עד שהוא נצמד.',
    bodyPart: 'core',
  },
  {
    id: 'x34',
    he: 'פלאנק פייק (Pike Plank)',
    en: 'Pike Plank',
    equip: ['Bodyweight'],
    muscle: 'ליבה · כתפיים',
    sets: 3,
    ...
    unit: 'חזרות',
    steps: [
      'פלאנק גבוה: ידיים מתחת לכתפיים, גוף קו ישר אחד, בהונות על מגבת/סליידרים או נגררות על הרצפה.',
      'משכו את האגן למעלה ואת הבהונות אל הידיים, רגליים ישרות, עד שהגוף בצורת V הפוכה והכתפיים מעל הידיים.',
      'עצרו שנייה בפסגה עם הבטן מכווצת.',
      'החזירו את הבהונות לאחור לפלאנק בשליטה, בלי לתת לאגן לשקוע.',
    ],
    cue: 'האגן עולה אל התקרה — הבטן מרימה את הרגליים, לא הזרועות.',
    mistake: 'טעות נפוצה: כיפוף הברכיים במקום הרמת האגן, או אגן שנופל מתחת לקו הגוף בחזרה לפלאנק.',
    bodyPart: 'core',
    split: { core: 0.7, shoulders: 0.3 },
  },
  {
    id: 'x35',
    he: 'לחיצת הקס (Hex Press)',
    en: 'Dumbbell Hex Press',
    equip: ['Dumbbells'],
    muscle: 'חזה פנימי · יד אחורית',
    sets: 3,
    reps: '10–12',
    rest: 75,
    unit: 'חזרות',
    steps: [
      'שכבו על ספסל שטוח, משקולת בכל יד באחיזה ניטרלית (כפות הידיים זו מול זו), והצמידו את המשקולות זו לזו מעל החזה.',
      'הורידו באיטיות אל אמצע החזה כשהמרפקים צמודים לצלעות — המשקולות נשארות צמודות כל הדרך.',
      'לחצו את המשקולות זו אל זו ודחפו מעלה בקו ישר עד כמעט נעילה.',
      'עצרו שנייה למעלה עם החזה מכווץ, והורידו שוב בשליטה (2–3 שניות).',
    ],
    cue: 'הלחיצה של המשקולות זו אל זו היא התרגיל — אל תרפו ממנה לרגע, גם בירידה.',
    mistake: 'טעות נפוצה: המשקולות נפרדות בדרך למעלה, או מרפקים שמתרחקים מהגוף והופכים את התרגיל ללחיצת חזה רגילה.',
    bodyPart: 'chest',
    split: { chest: 0.7, arms: 0.3 },
  },
];
